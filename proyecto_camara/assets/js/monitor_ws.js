        ...
        if('numeroConexion' === identificadorMensaje[1]){ 
          ...
          console.log("id_websocket cliente:"+id_websocket);
            ...
            if(existeCliente === -1){
                ...
                $( "#row_monitores" ).append( $( '<div class="col-md-4"><canvas style="width: 300px !important;height: 225px !important;" class="img-thumbnail" id="cliente-'+identificadorMensaje[1]+'" ></canvas><div>' ) );
                ...
                image.onload = function() {
                    contexto.drawImage(image, 0, 0, 300, 150);
                };
